...
const adminController = new adminController_1.AdminController(documentUseCase, authUseCase);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/documents/stats", adminController.getDocumentStats.bind(adminController));
/**
 * @swagger
 * /admin/documents/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/documents/:id", adminController.getDocumentById.bind(adminController));
/**
 * @swagger
 * /admin/users:
 *   get:
