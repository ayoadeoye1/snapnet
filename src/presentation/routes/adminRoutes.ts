...
const adminController = new AdminController(documentUseCase, authUseCase);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get("/documents", adminController.getAllDocuments.bind(adminController));
...
router.get(
  "/documents/stats",
  adminController.getDocumentStats.bind(adminController)
);
 ...
 *   get:
 *     tags: [Admin]
 *     summary: Get document by ID (admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
router.get(
  "/documents/:id",
  adminController.getDocumentById.bind(adminController)
);
