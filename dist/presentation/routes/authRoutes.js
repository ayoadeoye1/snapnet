 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put("/profile", auth_1.authenticateToken, authController.updateProfile.bind(authController));
/**
 * @swagger
 * /auth/password:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put("/password", auth_1.authenticateToken, authController.updatePassword.bind(authController));
